    ...
    return (
        ...
        {upcomingExams.length > 0 ? (
            ...
            <div className="flex items-center justify-between px-1">
                ...
                {totalExamCount > 3 && (
                <span className="text-[14px] text-muted-foreground cursor-pointer hover:font-semibold"       onClick={() => navigate("/exams", { state: { tab: "official" } })}>
                    전체 보기 →
                </span>
                )}
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
            ...
            <StatCard
                title="진행 중인 학생"
                value={`${stats?.total_students || 0}명`}
                trend="실시간 데이터"
                icon="Users"
                color="accent"
            />
